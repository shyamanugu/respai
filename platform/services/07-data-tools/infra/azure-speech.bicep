...
var speechAccountName = 'spch-${workloadName}-${environmentName}-${location}-${instance}'

// One shared Speech resource backs the STT/TTS pipeline tools. Unlike Search,
// there is no per-client isolation concern here — speech input/output is not
// stored by this account, only processed in-flight.
